...
<table>
	...
	<c:forEach items="${elab.userManagementProvider.teachers}" var="teacher">
    	<tr>
			...
			<td>
				<a href="../survey/results-for-teacher.jsp?id=${teacher.id}&type=pre">Pre-test Results</a>
			</td>
			<td>
				<a href="../survey/results-for-teacher.jsp?id=${teacher.id}&type=post">Post-test Results</a>
			</td>
		</tr>
	</c:forEach>
</table>
