...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Lateral Size Study Tutorial</title>
...
<h2>Tutorial - Using OGRE to Determine Lateral Size</h2>
...
<table border="0" id="main">
	<tr>
        ...
        <table width="665" border="0" align="left">
          <tr>
            <th height="135" scope="col" valign="top"><div align="center">
            ...
            <th scope="col"><ul><li>
              <div align="left"><strong>Review <a href="#" onclick="javascript:window.open('http://cmsinfo.cern.ch/outreach/CMSdocuments/DetectorDrawings/Slice/CMS_Slice.swf', 'cms', 'width=900,height=700, resizable=1, scrollbars=1');return false;">how particles interact with the CMS calorimeter</a> </strong></div>
            </li>
                <li>
                ...
                <li>
                  <div align="left">It would be helpful to have done the <a href="../analysis-shower-depth/index.jsp">Shower Depth</a> study first.&nbsp;&nbsp;</div>
                </li>
            </ul>            </th>
          </tr>
</table>
