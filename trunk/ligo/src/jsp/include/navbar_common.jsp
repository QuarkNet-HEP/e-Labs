...
<%
String curProject = "ligo";
if (!headerType.equals("Data")) {
%>
    <body onLoad="MM_preloadImages('graphics/home_button.gif','graphics/library_button.gif','graphics/data_button_alt.gif','graphics/poster_button.gif','graphics/site_button.gif','graphics/assess_button.gif')">
<%
} else {
%>
