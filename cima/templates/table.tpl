...
<div class=col-md-6>
<font size="1">
<strong>Instructions</strong> (also available as <a href="http://leptoquark.hep.nd.edu/~kcecire/drupal_lib/video2015/cima_4.swf" target="_blank">screencast</a>):
<br>
<ol>
					...
					<div class=col-md-3
						...
						<div style="background-color:none; padding: 0.5em 0.2em 0.5em 0.4em;">
							...
							<span style="display: inline-block; padding-top: 5%;"><!-- Event number span -->
					 			<?php
									 echo 'Event number: <span id="Eventid">';
									 if(isset($event)){
							...
							<div class=col-md-4
								...
								<div class="row"><div class=col-md-12>
										<div style="background-color:none; padding: 0.5em 0.2em 0.5em 0.4em;">
											<div>
												<input type="checkbox"
															 <?php echo 'onclick="SelP(this,'.round($event["mass"],$rnd).')"';?>
					...
					<div class=col-md-3
						...
						<span style="display: inline-block; padding-top: 5%;">
						  <span	style="color:grey"
							  ...
							  Z Mass: <input type="text" name="massEntry" id="massEntry"
															 size="4%" disabled="disabled"> GeV/c²
							</span>
						</span><br/>
						<span style="display: inline-block; padding-top: 5%; 
																								padding-bottom:5%;">
