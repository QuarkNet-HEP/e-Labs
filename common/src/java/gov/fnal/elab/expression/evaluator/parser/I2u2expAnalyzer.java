 ...
 *
 */
public abstract class I2u2expAnalyzer extends Analyzer {
    ...
    protected void enter(Node node) throws ParseException {
        switch (node.getId()) {
        case I2u2expConstants.LPAREN:
            enterLparen((Token) node);
            break;
        case I2u2expConstants.RPAREN:
            enterRparen((Token) node);
            break;
        case I2u2expConstants.COMMA:
        ...
        case I2u2expConstants.STRING:
            ...
            break;
        case I2u2expConstants.CHAR:
            enterChar((Token) node);
            break;
        case I2u2expConstants.MAIN:
            enterMain((Production) node);
            break;
        case I2u2expConstants.INVOCATION:
            enterInvocation((Production) node);
            break;
        case I2u2expConstants.ITEM:
            enterItem((Production) node);
            break;
        }
    }
    ...
    protected Node exit(Node node) throws ParseException {
        ...
        case I2u2expConstants.MAIN:
            return exitMain((Production) node);
        case I2u2expConstants.INVOCATION:
            return exitInvocation((Production) node);
        case I2u2expConstants.ITEM:
            return exitItem((Production) node);
        }
        return node;
    }
    ...
    protected void child(Production node, Node child)
        ...
        switch (node.getId()) {
        case I2u2expConstants.MAIN:
            childMain(node, child);
            break;
        case I2u2expConstants.INVOCATION:
            childInvocation(node, child);
            break;
        case I2u2expConstants.ITEM:
     ...
     * @throws ParseException if the node analysis discovered errors
     */
    protected void enterMain(Production node) throws ParseException {
    }
     ...
     * @throws ParseException if the node analysis discovered errors
     */
    protected void childMain(Production node, Node child)
        throws ParseException {
     ...
     * @throws ParseException if the node analysis discovered errors
     */
    protected void enterInvocation(Production node)
        throws ParseException {
    }
     ...
     * @throws ParseException if the node analysis discovered errors
     */
    protected Node exitInvocation(Production node)
        throws ParseException {
     ...
     * @throws ParseException if the node analysis discovered errors
     */
    protected void childInvocation(Production node, Node child)
        throws ParseException {
     ...
     * @throws ParseException if the node analysis discovered errors
     */
    protected void enterItem(Production node) throws ParseException {
    }
     ...
     * @throws ParseException if the node analysis discovered errors
     */
    protected void childItem(Production node, Node child)
        throws ParseException {
