...
public class VDCPool extends ElabObjectPool {
    ...
    // private final Class VDCclass =
    // Class.forName("org.griphyn.vdl.dbschema.VDC");
     ...
     */
    protected void recycle(Object obj) throws ElabException {
        return;
    }
    ...
    protected void destroy(Object obj) throws ElabException {
        return;
    }
