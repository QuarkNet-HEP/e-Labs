...
public class Script extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        try {          
            ...
            if (elab == null) {
                throw new JspException("elab:script requires elab.jsp to be included"); 
            }
            pageContext.getOut().write(elab.script((HttpServletRequest) pageContext.getRequest(), file));
        }
