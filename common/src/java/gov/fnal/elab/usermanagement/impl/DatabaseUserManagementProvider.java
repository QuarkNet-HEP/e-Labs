...
*/        
    ...
    /// JavaMail: see https://en.wikipedia.org/wiki/JavaMail for structure
	...
	/// Parentheses look weird, but are correct:
	/// Session mailSession = Session.getDefaultInstance(properties, big new thing {} );
