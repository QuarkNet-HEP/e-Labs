		...
		<body id="statusinfo" class="data">
				...
				<div id="container">
						...
						<div id="content">
								...
								<p>
										Try running the 
										<a href="${fn:escapeXml(run.attributes.onError)}?${fn:escapeXml(run.analysis.encodedParameters)}&runMode=${fn:escapeXml(run.analysis.attributes.runMode)}">analysis</a>
