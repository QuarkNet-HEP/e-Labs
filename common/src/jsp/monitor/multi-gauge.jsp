...
<%
	request.setAttribute("c", coords(request.getParameter("value1"), 50));
	request.setAttribute("d", coords(request.getParameter("value2"), 40));
	request.setAttribute("e", coords(request.getParameter("value3"), 30));
%>
