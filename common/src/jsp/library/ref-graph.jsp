...
<P>
<b>A Proper Plot</b><br> What are the necessary characteristics of an understandable plot or graph? Let's look at the standard format of an X-Y plot.
<P>
<b>Title/Key:</B>
    <UL>
...
which represent continuous validity, unlike the separate measured data points.
    ...
    <A HREF="http://www.teacherschoice.com.au/images/scientific_plot.gif">Scientific Plot</A> - good example of scale spacing and titles. Note actual data and theoretical data.
