...
output = open("output_thresh_check18.txt", "w")
#outputFiles = open("all_files_18.txt","w")
filenames = []
filenamesNoThresh = []
...
for root, dirs, files in os.walk("/disks/i2u2/cosmic/data"):
	for file in files:
		if not file.endswith(("log.log","raw.log","foo","splitLog",".zip",".sh", "more", "bak", "raw", "gz", "geo", "tmp", "blessing.txt", "thresh-java", "bless", "analyze", "meta", "Store", "raw.errors")):
