...
public class LifetimeBean extends ElabBean implements Serializable, MappableBean{
    ...
    private java.util.List geoFiles;
    ...
    public void setGeoFiles(java.util.List s){
        geoFiles = s;
    }

    public java.util.List getGeoFiles(){
        return geoFiles;
    }
    ...
    public boolean isGeoFilesValid(){
	return geoFiles != null;
    }
