...
public class FluxBean extends ElabBean implements Serializable, MappableBean{
    ...
    private java.util.List flux_geoFiles;
    ...
    public void setFlux_geoFiles(java.util.List s){
        flux_geoFiles = s;
    }

    public java.util.List getFlux_geoFiles(){
        return flux_geoFiles;
    }
    ...
    public boolean isFlux_geoFilesValid(){
    	return flux_geoFiles != null;
    }
    ...
    public java.util.List getInvalidKeys(){
        ...
        if(!isFlux_geoFilesValid()){
            badkeys.add("flux_geoFiles");
        }
    ...
    public Derivation mapToDV(Transformation tr,
        ...
        addToDV("flux_geoFiles", flux_geoFiles);
    ...
    public void mapToBean(Derivation dv) throws ElabException{
        ...
        flux_geoFiles = getDVValues("flux_geoFiles");
