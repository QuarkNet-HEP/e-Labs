...
String bandColor="#66CC33";
%>
<%@ include file="include/navbar_common.jsp" %>
<center>
<P>
<TABLE WIDTH=800 CELLPADDING=4>
<TR><TD   BGCOLOR="<%=bandColor%>">
...
{
%>
         <center>  <font size="+2" color="red">Please go back and enter the title for the poster.</font>   </center> 
<%
}
...
String tfile = "template_poster-cms.htmt";
String template = "";
try {
...
//String[] dir = new File(plotDir).list();
//ArrayList figureObj = new ArrayList();
//if (dir != null) {
//    for(int i=0; i<dir.length; i++) { // xxx: length or length() ???
//        String fn = dir[i];
///        String fnLC=fn.toLowerCase();
//        if (fnLC.endsWith(".gif") || fnLC.endsWith(".jpg") || fnLC.endsWith(".png") || fnLC.endsWith(".jpeg")){
//            figureObj.add(fn);
 //       }
//    }
//}
...
if(mylfnsmeta == null){
  ...
  //          "</font> did not return any results.<br>\n");
    out.println("<font size=-1>q = " + plotQuery + "</font>");
  return;
}
...
<span class="displayArial">
                   <table width="600"><tr><td>
                                   <UL><font size="-1">
                                      <LI>Fill in all the fields including Poster File Name if it is missing.  This is the name the poster file will get on the server. If you are making a new poster, do not use a name you have already used. To
...
%>
                <TR><TD valign="top" align="right">Poster Filename:<BR>(e.g.,poster_lifetime)</td><td valign="top"><input type="text" name="posterName" value="<%=posterName%>"></td></tr>
...
<%
                ...
                while (re.match(template,p)) {
                    ...
                    if (type.equals("PARA")) {
                      ...
                      //          String fo = (String) figureObj.get(i);
                      //          String selected = (fo.equals(val) ? " SELECTED" : "");
                      //          ht += "<OPTION" + selected + ">" + fo  + "\n";
                       //     }
                       // }
...
//if (reqType != null && reqType.equals("View Poster")) {
    if (posterNameEntered && posterTitleEntered)
    {
		...
		String myPlotURLPosters=(posterDir.substring(posterDir.indexOf("users")));
		String myPlotURL=myPlotURLPosters.substring(0,myPlotURLPosters.length()-8)+"plots/";
            String posterURL="displayPoster.jsp?type=poster&posterName="+posterName+".data&plotURL="+myPlotURL;
