...
var d_descr = {
	...
	"EcalPreshower3D_MODEL": {type: WIREFRAME, on: false, group: "Detector Model", desc: "ECAL Preshowers",
	...
	"CSCWireDigis_V1": { type: LINE, on: true, group: "Muon", desc: "CSC Wire Digis",
		fn: makeCSCWD, color: [0.8, 0, 0.8, 1], lineWidth: 0.5 },
	"CSCStripDigis_V1": { type: LINE, on: true, group: "Muon", desc: "CSC Strip Digis",
	...
	"EBRecHits_V2": { type: SHAPE, on: true, group: "ECAL", desc: "Barrel Rec. Hits", rank: "energy",
		fn: makeRecHits_V2, color: [1, 0.2, 0, 1], fill: [1, 0.2, 0.2, 1], lineWidth: 1 },
