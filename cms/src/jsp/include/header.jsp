...
<%-- Upgrading jQuery for plotter 28Nov2017 - JG --%>
<%-- jquery-3.2.1.min.js breaks the menu drop-downs in the header --%>
<%-- <script type="text/javascript" src="../include/jquery/js/jquery-1.4.3.min.js"></script>--%>
<script type="text/javascript" src="../include/jquery/js/jquery-2.2.4.min.js"></script>
