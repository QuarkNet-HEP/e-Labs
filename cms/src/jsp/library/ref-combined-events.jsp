	...
	<body onLoad="focus()" background="../graphics/Quadrille.gif">
		...
		<table WIDTH=600>
	    	<tr>
					...
					<p>Try this exercise (<a href="javascript:showRefLink('../games/event-id-new/cms_game_daddy-bars.html',850,750)">Safari/Firefox</a> - <a href="javascript:showRefLink('../games/event-id-new/cms_game_daddy-newgame.html',850,750)">Internet Explorer</a>) 
