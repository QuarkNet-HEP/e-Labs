		...
		<table WIDTH=600>
	    	<tr>
	    		<td>
					...
					<p>Now here's an example of a histogram made from many events like the ones shown above.</p>
					<img src="../graphics/fig02-23.gif" border="1">
					...
					<p><i>Going Further:</i>  Why are the distribution of events so broad and overlapping?  See here to <a href="ref-combined-distrib.jsp.html">go further</a>.</p>
				</td>
			</tr>
