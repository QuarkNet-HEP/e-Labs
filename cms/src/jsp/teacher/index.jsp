				...
				<p>
					...
					<ul>
						<li>Content and Investigation:
							<ul>
								<li>Identify and describe particles colliding in and emerging from collisions detected by CMS as predicted by the Standard Model.</li>
								...
								<li>Design, execute, write up and post an investigation of a testable hypothesis for which evidence can be provided using CMS data.</li> 								
							</ul>
						</li>
