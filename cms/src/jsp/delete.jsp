...
if(fileType != null && fileType.equals("poster")){
    barColor="66CC33"; //green for posters
    headerType = "Posters";
}
%>
...
<TR>
   <TD BGCOLOR="#<%=barColor%>">  <FONT COLOR=black><B>Delete your file.
   </B></FONT></TD>
</TR>
...
for (int i=0; i<filenames.length; i++){
    ...
    //TIBI: eliminate the replica catalog
    //String pfn = getPFN(file);
   pfnDir=request.getParameter("pfn");    
...
<%
    for (int i=0; i<filenames.length; i++){
        ...
        out.println("<input type=hidden name=pfn value="+pfnDir+">");
...
<%
    for (int i=0; i<filenames.length; i++){
        ...
        try{
        	out.println("TODO: Delete file :"+pfnDir.substring(0,pfnDir.length()-6) +"posters/"+filenames[i]);
