<nav class="navbar navbar-default" role="navigation">
  <div class="container-fluid">
	...
	<li style="float: right !important; align : right;"> <a href="https://www.i2u2.org/elab/cms/event-display/"><span class="glyphicon glyphicon-share-alt"></span> Event Display</a> </li>
      </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
