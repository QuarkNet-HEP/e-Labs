...
<%-- DIFFERS FROM THE COMMON.JSP IN /COMMON - GETPFN should not depend on the RC--%>
...
// EKQ - I may get rid of this later because elab_name.jsp has elabGuestUser defined with the guest for each eLab.
%>
...
/**
  ...
  */
  ...
  // CHANGE ME TO ELIMINATE DEPENDENCY ON RC
