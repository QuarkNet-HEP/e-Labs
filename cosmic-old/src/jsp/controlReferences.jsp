...
if (!session.getAttribute("UserName").equals("fermigroup"))
{
    warn(out, "You do not have premission to access this page!");
}
else
{
%>
            ...
            if (Set_Database)
            {
                ...
                //reads the newly created file into the Database
                    ...
                    while( (line = br.readLine()) != null)
                    {
                        ...
                        metaAdd.add("project string cosmic");
...
<option value="upload"<%if (type.equals("NA")) out.print(" selected"); %>>Upload
