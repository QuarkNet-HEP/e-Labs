...
<%
        ...
        if (thisPage.startsWith("/cosmic/teacher") || thisPage.startsWith("/cosmic/notes") ||
            thisPage.startsWith("/cosmic/standards") || thisPage.startsWith("/cosmic/site-map") ||
            thisPage.startsWith("/cosmic/registration") || thisPage.startsWith("/cosmic/project")) {
            teacherDump = "/cosmic/teacher.jsp";
        }
%>
...
<%
		    ...
		    else if(!headerType.equals("Home") && !teacherDump.equals("/cosmic/teacher.jsp")){
		    %>
