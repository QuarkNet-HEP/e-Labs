...
//provide access to all possible items to view logs on. 
     query="select id,keyword,description,section,section_id from keyword where keyword.project_id="+project_id + "order by section,section_id;";
    ...
    <%=linksToEach%>
        ...
        </tr>      <tr><td align="right"><IMG SRC="graphics/logbook_pencil.gif" align="center" border="0"></td><td align="left">Click to add and view comments on a logbook entry.</td>
        </tr>
