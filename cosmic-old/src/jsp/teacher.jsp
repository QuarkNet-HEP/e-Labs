<html>
	<head>
		<title>
			QuarkNet/Grid Teacher Information
		</title>
								...
								<table border="0" width="200">
									<tr>
										<td align="center">
											...
											<br>
											<form method="post" action="<%=action%>?prevPage=/cosmic/teacher.jsp">
												<table border="0" cellpadding="2" cellspacing="0">
													...
													<tr>
														...
														<td>
															<input size="16" type="password" name="pass" tabindex="2">
														</td>
													</tr>
													<tr>
                                                    ...
                                                    <tr>
                                                        <td align="center" colspan="3">
                                                            <font face="arial" size="-1">
                                                                ...
                                                                <br>
                                                                <a href="login.jsp?prevPage=/cosmic/teacher.jsp&amp;login=Login&amp;user=guest&amp;pass=guest">
                                                                    log in as guest</a>
                                                            </font>
                     ...
                     <td valign="top">
                       ...
                       <TABLE BORDER=0 WIDTH=200>
                           ...
                           <FONT FACE=ARIAL SIZE="-1">If you are not
                            ...
                            <BR>
                            <FORM method="post" action="logout.jsp?prevPage=/cosmic/teacher.jsp">
			...
			<td colspan="2" align="left">
				<blockquote>
					...
					<blockquote>
						...
						We provide refresher references for students who need to brush up on these skills. 
						<br>
						<a href="ref-start-bskills.jsp">
