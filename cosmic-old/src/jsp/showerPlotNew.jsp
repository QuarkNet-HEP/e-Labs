...
while((str = br.readLine()) != null){
    ...
    //String secStr = String.valueOf(date[6]);
    //String secStrTrunc = secStr.substring(0, 1);
    //int secInt = Integer.decode(secStrTrunc).intValue();
...
<center>
<font size="+1">Shower Study Candidates</font><br><br>
