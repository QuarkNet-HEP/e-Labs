...
if(headerType != null){
   ...
   // }
    ...
    if(headerType.equals("Home")){
        ...
        subLinks.add("ogre-new.jsp?analysis=shower_depth");
        subImages.add("spacer");
        subLinks.add("");
        subImages.add("lateral_size_button");
        subLinks.add("ogre-new.jsp?analysis=lateral_size");
        subImages.add("spacer");
        subLinks.add("");
        subImages.add("beam_purity_button");
        subLinks.add("ogre-new.jsp?analysis=beam_purity");
        subImages.add("spacer");
        subLinks.add("");
        subImages.add("resolution_button");
        subLinks.add("ogre-new.jsp?analysis=resolution");
        subImages.add("spacer");
        subLinks.add("");
