<div id="side-panel">
	...
	<ul id="left-links">
		...
		<li><a href="/glossary/"  target="blank">Glossary</a></li>
	  <li><a href="/ligo/tla/">Bluestone</a></li>
     <li><a href="/library/index.php/Bluestone_Tutorial">Tutorial</a></li>
</ul>
	<img src="../graphics/lho_aerial.jpg" width="120" height="130" />
	<img src="../graphics/llo_aerial.jpg" width="120" height="130" />
</div>
