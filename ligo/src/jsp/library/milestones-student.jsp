<UL><li> A. Get Started: <i>Prepares the team to design the investigation.</i></li>
					<ul>
						<li>
...
<li> B. Figure It Out:  <i>Prepares the team to analyze data:</i></li>
					<ul>
						<li>
...
<li> C. Tell Others:  <i>Prepares the team to enter into scientific discourse with other researchers.</i></li>
					<ul>
						<li>
