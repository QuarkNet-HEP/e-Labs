				...
				<ol type="A">
					<li>
						...
						<ul>
							<li>
								Simple Measurements.
								<a href="javascript:reference('measurements',420)">
					...
					<li>
						Get Started: <i>Prepares the team to design the investigation.</i>
						<ul>
							<li>
					...
					<li>
						Tell Others: <i>Prepares the team to enter into scientific discourse with other researchers.</i>
						<ul>
							<li>
