	...
	<c:if test="${not empty group}">
		<table id="group-form" class="form">
			...
			<tr>
				...
				<td>
					<e:trselect name="ay" valueList="AY2004, AY2005, AY2006, AY2007, AY2008, AY2009"
						labelList="2004-2005, 2005-2006, 2006-2007, 2007-2008, 2008-2009, 2009-2010"
						value="${group.year}"/>
				</td>
			</tr>
			<tr>
				...
				<td>
					<e:trselect name="role" valueList="user, teacher"
						labelList="user, teacher" value="${group.role}"/>
				</td>
			</tr>
			<tr>
				<td>
