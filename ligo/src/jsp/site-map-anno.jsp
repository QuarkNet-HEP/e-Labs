...
<B>Homepage</B>
<P>
<LI STYLE="margin-left: 10px">Develop a research topic.
<P>
...
<B>Upload</B></P>
<P>
<LI STYLE="margin-left: 10px">Choose and plot your LIGO data
<P>
</FONT>
</TD></TR>
</TABLE>
...
<P>
<LI STYLE="margin-left: 10px">Physicists -  Contacts at LIGO</LI>
<P>
<LI STYLE="margin-left: 10px">Student Research Groups - Other studies in the field</LI>
<P>
<LI STYLE="margin-left: 10px">Tutorials - Learn how to use LIGO Data Analysis software</LI>
<P> 
<LI STYLE="margin-left: 10px">Animations - How LIGO works</LI>
<P>  
</TD></TR>
</TABLE>
<P>
...
<P>
<LI STYLE="margin-left: 10px">Analysis tips.
<P>
