/***********************************************************************\
 * frame_test.C  - simple non-graphical test routine
 *
\***********************************************************************/
...
\***********************************************************************/
void
frame_test(int GPS_start_time=869320034,
	   int GPS_end_time=869406434,
	   TString ttype="M"){
  int rc;
  Int_t i;
  FILE *fp, *fopen();
  ...
  printf("BEGIN frame_test(%d, %d",  GPS_start_time, GPS_end_time);
  printf(", \"%s\")\n", ttype.Data());

  printf("frame_test.C: ROOT %s as of %d \n",
