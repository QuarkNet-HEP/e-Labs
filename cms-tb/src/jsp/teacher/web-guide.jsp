...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>CMS e-Lab Teacher Information</title>
...
<p>	Think of this map as a subway map with one main line and four branch lines.  Along the main line are stops, milestone seminars, opportunities to check how the work is going. Off each main stop are branch lines where each stop is a project milestone. The branch lines include:</p> 
	<ul>
		...
		<li>
			...
			investigation with links to information about particles,  the CMS detector subsystems, data, studies
			and a research plan.
		</li>
		<li>
			<strong>Figure It Out:</strong> Prepares the team to ananlyze data with 
			links to how to choose data and the OGRE
			analysis tool, etc.
		</li>
		<li>
...
<p>
	...
	<ul>
		<li><strong>Tutorials:</strong> Tutorials for each of the studies and ROOT.</li>
		<li><strong>Contacts:</strong> Experts and student research groups.</li>
		<li><strong>Online:</strong> Other URLs of interest.</li>
		<li><strong>Slide Shows:</strong> Aids to help students understand detector, 
