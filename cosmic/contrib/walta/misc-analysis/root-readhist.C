...
strcpy(Xaxisstring, "Time between two channels (nanoseconds)");
...
Int_t files=1;
strcpy(filename[0],"data.txt");
strcpy(filename[1],"muondecay_threehit.txt");
strcpy(filename[2],"muondecay_threehit.txt");
strcpy(filename[3],"muondecay_threehit.txt");
strcpy(filename[4],"muondecay_threehit.txt");
strcpy(filename[5],"muondecay_threehit.txt");

int read_by_number = 0;  i = 0;
