...
public class ThresholdTimes {
	//TESTING UPDATED THRESHOLDTIMES
    ...
    private void printData(int channel, String[] parts, String detector, BufferedWriter wr) throws IOException {
        ...
        if (computeJD) {
            ...
            //}
            //System.out.println(String.valueOf(lastjdplustime));
            if (lastjdplustime > 0) {
            ...
            System.out.println(String.valueOf(jd));
...
//	        if (diff < -0xaaaaaaaal) {
    ...
    private static int currLineJD(double offset, String[] parts) {
        ...
        double jd = gregorianToJulian(parts, year, month, day, hour, min, (int) secOffset);
