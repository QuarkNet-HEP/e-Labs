...
<% 
		...
		if(rawData != null) {
			List thresholdAll = AnalysisParameterTools.getThresholdFiles(elab, rawData);
			...
			%>
	        <e:trdefault name="thresholdAll" value="<%= thresholdAll %>"/>
...
<% } else { %>
<e:analysis name="analysis" type="I2U2.Cosmic::PerformanceStudyTT" >
<% 
		ElabAnalysis analysis = (ElabAnalysis) request.getAttribute("analysis");
		Collection rawData = analysis.getParameterValues("rawData");
		if(rawData != null) {
