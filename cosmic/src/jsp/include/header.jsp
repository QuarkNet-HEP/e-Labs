			...
			<c:if test='${user.name != "guest" }'>					
				<c:choose>
					<c:when test="${user.teacher}">
						...
						<e:popup href="../logbook/showLogbookT.jsp" target="log" width="800" height="600"><img title="Logbook" src="../graphics/logbook.png" /></e:popup>
					</c:when>
					<c:otherwise>
						<e:popup href="../logbook/showLogbook.jsp" target="log" width="800" height="600"><img title="Logbook" src="../graphics/logbook.png" /></e:popup>
					</c:otherwise>
				</c:choose>
