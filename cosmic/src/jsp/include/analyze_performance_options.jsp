                ...
                <tr>
                    <td>
                        <div id='analyzeParam0' style="visibility:visible;display:">
                            <table width="100%" align="center">
                                <tr>
                                    <td align="right" width="40%"><a href="javascript: describe('Quarknet.Cosmic::SingleChannel','channel','Channel Number')"><IMG SRC="graphics/question.gif" border="0"></A>
                                            Channel Number:
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td align="right"><a href="javascript:describe('Quarknet.Cosmic::PerformanceStudyNoThresh','freq_binValue','Bin Width')"><IMG SRC="graphics/question.gif" border="0"></A>
                                        Number of Bins:
                                    </td>
                                    <td>
                                        <input type="text" name="freq_binValue" value="40" size="6" onChange="{plot_caption.value='<%=rawDataString%>\n<%=detectorIDString%>\nChannel: ' + singlechannel_channel.value;}">
                        ...
                        <div id='plotParam0' style="visibility:hidden;display:none;">
                            <table width="100%" align="center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="plot_title" value="Performance Study" size="40" maxlength="100">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
...
Channel: <%=chan%></textarea>
            ...
            <input type="hidden" name="freq_col" value="5">
            <input type="hidden" name="plot_extraFunctions" value="">
            <input type="hidden" name="plot_plot_type" value="0">
            <input type="hidden" name="plot_xlabel" value="Time over Threshold (nanosec)">
            <input type="hidden" name="plot_ylabel" value="Number of muons">
            <input type="hidden" name="plot_highZ" value="">
            <input type="hidden" name="plot_lowZ" value="">
            <input type="hidden" name="plot_zlabel" value="">
            <input type="hidden" name="html_title" value="Time over Threshold Histogram">
            <div align="center">
