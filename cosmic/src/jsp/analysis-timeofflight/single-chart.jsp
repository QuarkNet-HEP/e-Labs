...
<div class="left">
	...
	<div id="binning" style="border: 1px dotted black">			
		<div id="incdec<%= request.getParameter("chartIndex") %>" style="width:245px;">Bin Width
	   		<input type="number" name="binWidth<%= request.getParameter("chartIndex") %>" id="binWidth<%= request.getParameter("chartIndex") %>" min="1.0" style="width: 60px;"/>
		</div>
		<div class="slider" style="width:245px;">
	    	<input id="range<%= request.getParameter("chartIndex") %>" type="range" min="1.0" style="width: 240px;"></input>
	    </div>
	    <br />
	</div>
