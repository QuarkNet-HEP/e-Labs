	...
	<table width="655">
		<tr>
 			...
 			<td colspan=3>
 				...
 				<p>1.  We set up the detector and collect data with two counters stacked, one on top of the other. <img src="../graphics/stacked.gif" /> 
 				The top counter is connected to channel 1, and the bottom counter is connected to channel 4.  
				...
				Why do we use the distribution mean?</e:popup><br></br>
				...
				<font color="blue">1 muon</font> hitting both counters. <br></br>
