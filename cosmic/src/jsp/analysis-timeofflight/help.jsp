...
<%--
	<h2>Help</h2> 
	<p><a href="tutorial.jsp">Tutorial on Time of Flight study</a></p>
	<p><e:popup href="tryit.html" target="tryit" width="600" height="600">Step-by-step instructions</e:popup></p>
