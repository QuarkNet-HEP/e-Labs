...
function drawAnalysis(l,g) {	
	...
	var dataX1 = {
	  ...
	  datasets: [
	    {
	      label: 'X CAEN 0 '+globalThis.selectedFileClean, // Label for the dataset
	...
	var dataX2 = {
	  ...
	  datasets: [
	    {
	      label: 'X CAEN 2 '+globalThis.selectedFileClean,
	...
	var dataX3 = {
	  ...
	  datasets: [
		{
	      label: 'X CAEN 4 '+globalThis.selectedFileClean,
	...
	var dataY1 = {
	  ...
	  datasets: [
	    {
	      label: 'Y CAEN 1 '+globalThis.selectedFileClean, // Label for the dataset
	      backgroundColor: 'rgba(54, 162, 235, 0.5)', // Color or array of colors for the bars
	...
	var dataY2 = {
	  ...
	  datasets: [
	    {
	      label: 'Y CAEN 3 '+globalThis.selectedFileClean,
	       backgroundColor: 'rgba(255, 99, 132, 0.5)',
	       data: populateY('y', 1),
	     },
	  ],
	...
	var dataY3 = {
	  ...
	  datasets: [
	        {
	      label: 'Y CAEN 5 '+globalThis.selectedFileClean,
	       backgroundColor: 'rgba(20, 255, 132, 0.5)',
	       data: populateY('y', 2),
	          options: options,
	     },
	...
	var DXDYdatasets = {
	  ...
	  datasets: [
	     {
	       label: 'DX - DY '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
		 ...
		 {
		   label: 'DX - DY Top/Middle '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
		 ...
		 {
		   label: 'DX - DY Middle/Bottom '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
	...
	var deltaXFrequency = {
	  ...
	  datasets: [
	     {
	       label: 'DX Frequency Distribution '+globalThis.selectedFileClean, // Label for the dataset
		   //borderColor: 'gray',
		 ...
		 {
		   label: 'DX Top/Middle Frequency Distribution '+globalThis.selectedFileClean, // Label for the dataset
		   //borderColor: 'gray',
		   backgroundColor: 'yellow', // Color or array of colors for the bars
		 ...
		 {
		   label: 'DX Middle/Bottom Frequency Distribution '+globalThis.selectedFileClean, // Label for the dataset
		   //borderColor: 'gray',
	...
	var deltaYFrequency = {
	  ...
	  datasets: [
	     {
	       label: 'DY Frequency Distribution '+globalThis.selectedFileClean, // Label for the dataset
		   //borderColor: 'gray',
		 ...
		 {
		   label: 'DY Top/Middle Frequency Distribution '+globalThis.selectedFileClean, // Label for the dataset
		   //borderColor: 'gray',
		 ...
		 {
		   label: 'DY Middle/Bottom Frequency Distribution '+globalThis.selectedFileClean, // Label for the dataset
		   //borderColor: 'gray',
	...
	var frequencyTopMapX = {
	  ...
	  datasets: [
	     {
	       label: 'Frequency of X Top Cells on Track '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
	       backgroundColor: 'green', // Color or array of colors for the bars
		 ...
		 {
		   label: 'Frequency of X Top Cells on Half-Track '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
		   backgroundColor: 'yellow', // Color or array of colors for the bars
	...
	var frequencyMiddleMapX = {
	  ...
	  datasets: [
	     {
	       label: 'Frequency of X Middle Cells on Track '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
		 ...
		 {
		   label: 'Frequency of X Middle Cells on Half-Track (Top/Middle) '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
		   backgroundColor: 'yellow', // Color or array of colors for the bars
		 ...
		 {
		   label: 'Frequency of X Middle Cells on Half-Track (Bottom/Middle '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
		   backgroundColor: 'blue', // Color or array of colors for the bars
	...
	var frequencyBottomMapX = {
	  ...
	  datasets: [
	     {
	       label: 'Frequency of Bottom X cells on Track '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
	       backgroundColor: 'blue', // Color or array of colors for the bars
		 ...
		 {
		   label: 'Frequency of X Bottom Cells on Half-Track '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
	...
	var frequencyTopMapY = {
	  ...
	  datasets: [
	     {
	       label: 'Frequency of Top Y cells on Track '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
	       backgroundColor: 'green', // Color or array of colors for the bars
		 ...
		 {
		   label: 'Frequency of Y Top Cells on Half-Track '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
		   backgroundColor: 'yellow', // Color or array of colors for the bars
	...
	var frequencyMiddleMapY = {
	  ...
	  datasets: [
	     {
	       label: 'Frequency of Y Middle Cells on Track '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
		 ...
		 {
		   label: 'Frequency of Y Middle Cells on Half-Track (Top/Middle) '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
		 ...
		 {
		   label: 'Frequency of Y Middle Cells on Half-Track (Bottom/Middle '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
		   backgroundColor: 'yellow', // Color or array of colors for the bars
	...
	var frequencyBottomMapY = {
	  ...
	  datasets: [
	     {
	       label: 'Frequency of Bottom Y cells on Track '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
		 ...
		 {
		   label: 'Frequency of Y Bottom Cells on Half-Track '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
		   backgroundColor: 'lightgreen', // Color or array of colors for the bars
	...
	var DXDZDYDZdatasets = {
	  ...
	  datasets: [
	     {
	       label: 'DX/DZ - DY/DZ '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
	       backgroundColor: 'cyan', // Color or array of colors for the bars
	...
	var DXDZDYDZTMdatasets = {
	  ...
	  datasets: [
	     {
	       label: 'DX/DZ - DY/DZ (TOP-MIDDLE) '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
	       backgroundColor: 'yellow', // Color or array of colors for the bars
	...
	var DXDZDYDZMBdatasets = {
	  ...
	  datasets: [
	     {
	       label: 'DX/DZ - DY/DZ (MIDDLE-BOTTOM) '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'gray',
	       backgroundColor: 'orange', // Color or array of colors for the bars
	...
	var deltaTdatasets = {
	  ...
	  datasets: [
	    {
	      label: 'Delta T CAEN 1 - CAEN 0 '+globalThis.selectedFileClean, // Label for the dataset
		  borderColor: 'orange',
	      backgroundColor: 'orange', // Color or array of colors for the bars
		 ...
		 {
		   label: 'Delta T CAEN 2 - CAEN 0 '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'purple',
		   backgroundColor: 'purple', // Color or array of colors for the bars
		 ...
		 {
		   label: 'Delta T CAEN 3 - CAEN 0 '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'yellow',
		   backgroundColor: 'yellow', // Color or array of colors for the bars
		 ...
		 {
		   label: 'Delta T CAEN 4 - CAEN 0 '+globalThis.selectedFileClean, // Label for the dataset
		 ...
		 {
		   label: 'Delta T CAEN 5 - CAEN 0 '+globalThis.selectedFileClean, // Label for the dataset
		   borderColor: 'pink',
		   backgroundColor: 'pink', // Color or array of colors for the bars
	...
	var dT42 = {
	  ...
	  datasets: [
	    {
	      label: 'Delta T CAEN 4 - CAEN 2 '+globalThis.selectedFileClean, // Label for the dataset
		  borderColor: 'brown',
	...
	var dT13 = {
	  ...
	  datasets: [
	    {
	      label: 'Delta T CAEN 1 - CAEN 3 '+globalThis.selectedFileClean, // Label for the dataset
		  borderColor: 'blue',
	      backgroundColor: 'blue', // Color or array of colors for the bars
	...
	var dT15 = {
	  ...
	  datasets: [
	    {
	      label: 'Delta T CAEN 1 - CAEN 5 '+globalThis.selectedFileClean, // Label for the dataset
		  borderColor: 'red',
	      backgroundColor: 'red', // Color or array of colors for the bars
	...
	var dT35 = {
	  ...
	  datasets: [
	    {
	      label: 'Delta T CAEN 3 - CAEN 5 '+globalThis.selectedFileClean, // Label for the dataset
	...
	var numberTracks4TM = {
	  ...
	  datasets: [
	        {
	       label: '# of events (4) top-middle with tracks (per minute) '+globalThis.selectedFileClean,
	...
	var numberTracks4MB = {
	  ...
	  datasets: [
	        {
	       label: '# of events (4) middle-bottom with tracks (per minute) '+globalThis.selectedFileClean,
	...
	var numberTracks5M = {
	  ...
	  datasets: [
	        {
	       label: '# of events (5) with tracks (per minute-MIDDLE missing) '+globalThis.selectedFileClean,
	...
	var numberTracks5TB = {
	  ...
	  datasets: [
	        {
	       label: '# of events (5) with tracks (per minute-TOP or BOTTOM missing) '+globalThis.selectedFileClean,
	...
	var numberTracks6 = {
	  ...
	  datasets: [
	        {
	       label: '# of events (6) with tracks (per minute) '+globalThis.selectedFileClean,
	...
	var scatterChartADCX1 = new Chart(X1ADC, {
        ...
        data: {
          datasets: [{
            label: 'X CAEN 0 Paired ADC '+globalThis.selectedFileClean,
            data: popXADR(0),
	...
	var scatterChartADCX1Average = new Chart(X1ADCAverage, {
	    ...
	    data: {
	      datasets: [{
	        label: 'X CAEN 0 Paired ADC-Average '+globalThis.selectedFileClean,
	...
	var scatterChartADCX2 = new Chart(X2ADC, {
        ...
        data: {
          datasets: [{
            label: 'X CAEN 2 Paired ADC '+globalThis.selectedFileClean,
            data: popXADR(1),
            backgroundColor: 'rgba(54, 162, 235, 0.6)', // Color of the data points
            pointRadius: 5, // Size of the data points
          }]
	...
	var scatterChartADCX2Average = new Chart(X2ADCAverage, {
	    ...
	    data: {
	      datasets: [{
	        label: 'X Layer 2 Paired ADC-Average '+globalThis.selectedFileClean,
	...
	var scatterChartADCX3 = new Chart(X3ADC, {
        ...
        data: {
          datasets: [{
            label: 'X CAEN 4 Paired ADC '+globalThis.selectedFileClean,
            data: popXADR(2),
            backgroundColor: 'rgba(54, 162, 235, 0.6)', // Color of the data points
            pointRadius: 5, // Size of the data points
          }]
	...
	var scatterChartADCX3Average = new Chart(X3ADCAverage, {
	    ...
	    data: {
	      datasets: [{
	        label: 'X CAEN 4 Paired ADC-Average '+globalThis.selectedFileClean,
	...
	var scatterChartADCY1 = new Chart(Y1ADC, {
        ...
        data: {
          datasets: [{
            label: 'Y CAEN 1 Paired ADC '+globalThis.selectedFileClean,
            data: popYADR(0),
            backgroundColor: 'rgba(54, 162, 235, 0.6)', // Color of the data points
            pointRadius: 5, // Size of the data points
          }]
	...
	var scatterChartADCY1Average = new Chart(Y1ADCAverage, {
	    ...
	    data: {
	      datasets: [{
	        label: 'Y CAEN 1 Paired ADC-Average '+globalThis.selectedFileClean,
	...
	var scatterChartADCY2 = new Chart(Y2ADC, {
        ...
        data: {
          datasets: [{
            label: 'Y CAEN 3 Paired ADC '+globalThis.selectedFileClean,
            data: popYADR(1),
            backgroundColor: 'rgba(54, 162, 235, 0.6)', // Color of the data points
            pointRadius: 5, // Size of the data points
          }]
	...
	var scatterChartADCY2Average = new Chart(Y2ADCAverage, {
	    ...
	    data: {
	      datasets: [{
	        label: 'Y CAEN 3 Paired ADC-Average '+globalThis.selectedFileClean,
	...
	var scatterChartADCY3 = new Chart(Y3ADC, {
        ...
        data: {
          datasets: [{
            label: 'Y CAEN 5 Paired ADC '+globalThis.selectedFileClean,
            data: popYADR(2),
            backgroundColor: 'rgba(54, 162, 235, 0.6)', // Color of the data points
            pointRadius: 5, // Size of the data points
          }]
	...
	var scatterChartADCY3Average = new Chart(Y3ADCAverage, {
	    ...
	    data: {
	      datasets: [{
	        label: 'Y CAEN 5 Paired ADC-Average '+globalThis.selectedFileClean,
