...
<e:analysis name="analysis" type="I2U2.Cosmic::ShowerLifetimeHybridStudy">
	<%
	...
	<e:ifAnalysisIsOk>
		<jsp:include page="../analysis/start.jsp?continuation=../analysis-shower-hybrid/output.jsp&onError=../analysis-shower-hybrid/analysis.jsp"/>
	</e:ifAnalysisIsOk>
	<e:ifAnalysisIsNotOk>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Choose hybrid study parameters</title>
...
<c:choose>
	<c:when test="${analysis.parameters.rawData != null}">
		<h1>Calculate hits and pulsewidths in the detector</h1>
		<!-- 
...
<table border="0" id="main">
			<tr>
				<td id="center">
					<p>
						<a href="../analysis-shower-hybrid/tutorial.jsp">Understand the graph</a>
					</p>
