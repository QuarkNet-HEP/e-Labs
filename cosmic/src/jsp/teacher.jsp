		...
		<td>
			<div id="center">
				...
				<ul>
					...
					<li>
						<a href="presurvey.jsp?type=pre&student_id=0">Pre</a>
						- and <a href="presurvey.jsp?type=post&student_id=0">post</a>
						- tests of content knowledge and student results for 
						<a href="surveyResults.jsp?type=pre">pre</a>
						- and <a href="surveyResults.jsp?type=post">post</a>- tests.
					</li>
					<li>
