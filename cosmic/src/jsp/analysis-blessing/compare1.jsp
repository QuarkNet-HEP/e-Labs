		...
		<div id="container">
			...
			<div id="content">
				...
				<table width="100%" style="text-align: left;">
					<tr><td width="10px">CR0: </td><td><strong><%= entry.getTupleValue("ConReg0") != null? entry.getTupleValue("ConReg0") : "Unknown" %></strong></td>
					<tr><td></td><td><strong>${CR0}</strong></td></tr>
				</table>
				...
				<div id="xAxesControl">
					<table id="xAxesControlTable">
						<tr>
							...
							<td style="background-color: lightGray"><input type="button" value="Reset" id="XResetButton" onclick='javascript:resetPlotX("maxX");' /></td>
						</tr>
					</table>
				</div>
				<h2>Rates</h2>
