				...
				<div class="tab">
					...
					<div class="tab-contents">
						...
						<ul>
							...
							<li>
								Put it together in a research proposal.
			...
			<div id="right">
				<div class="tab">
					...
					<div class="tab-contents">
						...
						<ul>
							<li>
								Collect data and upload files to our server (teams with detectors). 
							...
							<li>
								...
								<a href="javascript:reference('search parameters',420)">
									<img src="../graphics/ref.gif">
								</a>
							</li>
							<li>
								Choose and use appropriate analysis tools. 
								<a href="javascript:reference('analysis tools',450)">
									<img src="../graphics/ref.gif">
								</a>
							</li>
							<li>
								Measure and correct for background and errors when appropriate. 
				...
				<a href="milestones-map.jsp">
					<img class="bordered" src="../graphics/workflow_map5_small.gif"/>
				</a>
			</div>
		</td>
	</tr>
