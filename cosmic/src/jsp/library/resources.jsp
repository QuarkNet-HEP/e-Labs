		...
		<div id="right">		
			...
			<div class="tab" id="tab-online">
				...
				<div class="tab-contents-sublevel">
					...
					<ul class="simple">
						<li>See <a href="https://www.youtube.com/watch?v=LZDSLzU9pZ4" target="_blank">The Grid</a> and <a href="https://www.youtube.com/watch?v=KxFZG7KZZcA" target="_blank">Spotlight on CERN: the Grid computing</a> for an introduction.  From there, go to <a href="http://gridtalk.org/">Grid Talk</a> where you can read 
