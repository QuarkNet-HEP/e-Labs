		...
		<div id="right">		
			...
			<div class="tab" id="tab-online">
				...
				<div class="tab-contents-sublevel">
					...
					<ul class="simple">
						<li><a href="https://www.youtube.com/watch?v=LZDSLzU9pZ4">The Grid</a> and <a href="https://www.youtube.com/watch?v=KxFZG7KZZcA">Spotlight on CERN: the Grid computing</a> for an introduction.  From there, go to <a href="http://gridtalk.org/">Grid Talk</a> where you can read 
