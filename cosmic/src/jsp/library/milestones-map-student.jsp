...
<area shape="rect" alt="" coords="715,19,773,63" href="${post}" title="Take the post-test. See what you learned.">
<area shape="rect" alt="" coords="0,19,58,63" href="${pre}" title="Take the pre-test. See what you already know.">
