	...
	<tr>
		<td>
			<div id="left">
				...
				<div class="tab" id="tab_tutorials">
					<span class="tabtitle">Tutorials</span>
					<div class="tabcontents">
						<ul class="simple">
							<li>
								<a href="javascript:openPopup('tryit_performance.html','TryIt',520,600)">Step-by-Step Instructions</a>
								and <a href="dpstutorial.jsp">Performance Study Background</a>
								 - Understand how to do and interpret the output of the Performance Study.
							</li>
							<li>
           						<a href="javascript:openPopup('tryit_lifetime.html','TryIt',520,600)">Step-by-Step Instructions</a>
								and  <a href="ltimetutorial.jsp">Lifetime Study Background</a>
								- Discover how to read a Lifetime Study graph.
							</li>
							<li>
								<a href="javascript:openPopup('tryit_flux.html','TryIt',520,600)">Step-by-Step Instructions</a>
								and <a href="fluxtutorial.jsp">Flux Study Background</a>
								- Learn how to understand the results of a Flux Study.
							</li>
							<li>
								<a href="javascript:openPopup('tryit_shower.html','TryIt',520,600)">Step-by-Step Instructions</a>
								and  <a href="eshtutorial.jsp">Shower Study Tutorial</a>
			...
			<div id="right">
				<div class="tab" id="tab_contacts">
					...
					<div class="tabcontents">
						...
						<h2><a href="students.jsp">Student Research Groups</a></h2>
					</div>
				</div>
				
				<div class="tab" id="tab_animations">
