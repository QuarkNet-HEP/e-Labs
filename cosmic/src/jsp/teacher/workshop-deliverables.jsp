...
<e:transclude
 url="http://${elab.properties['elab.host']}/cosmic/library/body.php?title=Workshop_Deliverables"
     start="<!-- start content -->"
...
<e:transclude
 url="http://${elab.properties['elab.host']}/cosmic/library/body.php?title=Implementation_Plan_Section"
     start="<!-- start content -->"
      end="<div class=\"printfooter\">"
/>
