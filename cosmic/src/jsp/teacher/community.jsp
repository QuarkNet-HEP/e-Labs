...
<html>
	<head>
		<title> Cosmic Ray e-Lab Teacher Community</title>
...
<a name="Library"></a><h2>I2U2 WordPress Blog (Going away Feb 1, 2014 for lack of use)</h2>
<p><strong>-Please save any posts that might be important to you-</strong></p></h2>
...
<ul><li> <a href="http://www18.i2u2.org/blog/category/cosmic-implementation-plan/" target="blog">Cosmic Implementation Plans</a> -  Share implementation plans and comment on plans of others. As part of a Cosmic workshop, teachers create an implementation plan for using the e-Lab with their students.  As a starting point to any posts, view the <a href="http://www18.i2u2.org/blog/posting-implementation-plans/"  target="blog">Posting Implementation Plans</a>. You can continue this discussion well after the initial workshop. You can also post your WordPress entries to Facebook and other social media sites.
</li>

<li><a name="Classroom Activities"> </a><a href="http://www18.i2u2.org/blog/cosmic-class-activities/" target="blog">Cosmic Classroom Activities</a> - Post your ideas on how to incorporate the e-Lab into your classes and what activities work well. Your ideas may make it to the page of exemplary Classroom Activities.  When you post, be sure to assign a category of "Cosmic Classroom Activity".  Click "Cosmic Classroom Activity" in the Category list on the right to see all posts and comments.</li>

<li><a href="http://www.i2u2.org/blog/" target="blog">General Blogging</a> - Join us for discussions about the Cosmic Ray e-Lab.  Here you are free to post any questions, answers to questions others ask and comment on their posts. Make suggestions on how to improve the I2U2 Blog.
</li>
