...
PMTs have signals above some predetermined threshold voltage, within a certain time window). </p>

<p>The output data record, which can be sent via a standard RS-232 serial interface to any PC, 
...
and stopping times for each detected pulse. </p>
...
such as counting rates, auxiliary GPS data, and environmental sensor data (temperature and pressure). 
    ...
    <p>
	User Manuals: <a href="http://quarknet.org/sites/default/files/cf_6000crmdusermanual-small.pdf">Series "6000"</a> </p>
    <p>
	Assembly Instructions: <a href="http://quarknet.org/sites/default/files/cf_crmdassemblyinstructions-small.pdf">Series "6000"</a></p>
    <p>
	Series "6000" CRMD Plateauing Instructions: <a href="http://quarknet.org/sites/default/files/quarknet/cf_6000crmd_how_to_plateau.ppt">PowerPoint HOWTO</a> - 
	<a href="http://quarknet.org/sites/default/files/quarknet/cf_6000plateau_template.xls">Spreadsheet</a></p>
    <p>
