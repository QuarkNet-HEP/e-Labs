						...
						<div id="content">
								...
								<c:choose>
										...
										<c:otherwise>
												...
												<div id="newsbox-h" style="visibility:visible; display"></div>
										</c:otherwise>
								</c:choose>
								<%-- End Newsbox --%>
												...
												<td><div id="expandHeading">
														...
														<div id="vsId6-h" style="visibility:visible; display">
																...
																<div style="margin-left: 20px">
																		...
																		<ul>
																				<li><a href="mailto:adams@fnal.gov">Mark Adams</a> if you are a member of QuarkNet.</li>
														...
														<div id="vsId7-h" style="visibility:visible; display">
																...
																<p>
																		<table style="margin-left:20px">
																				<tr>
																						<td>Use the <a href="/elab/cosmic/teacher/forum/HelpDeskRequest.php?elab=cosmic" class="external text" title="/elab/cosmic/teacher/forum/HelpDeskRequest.php?elab=Cosmic" rel="nofollow">Help Desk Form</a> to get technical assistance from our staff. Click on the lifesaver
