...
<%
        ...
        request.setAttribute("eventStart", es);
        int eventStart;
        ...
        String eventCandidates = (String) analysis.getParameter("eventCandidates");
        request.setAttribute("eventCandidates", eventCandidates);
%>
...
<p>
<form name="saveAllForm" action="save-all-events.jsp" method="post" target="saveAllWindow" onsubmit="window.open('',this.target,'width=500,height=500,top=200,left=500 resizable=1');" align="center">
        ...
        <input type="hidden" name="eventStart" value="<%=eventStart %>" />
        ...
        <input type="submit" name="saveAllEvents" id="savelAllEvents" value="Save All Events" />
</form>
</p>
<p>
