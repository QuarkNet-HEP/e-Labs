...
<%
	...
	if (srs != null && !srs.isEmpty()) {
		...
		/* Get known checked value, generate a string for jQuery to parse */
		Pair<Integer, String> p = (Pair) session.getAttribute("rawDataMap");
		if ((p != null) && (com.mallardsoft.tuple.Tuple.get1(p) == pageNo)) {
			int storedPage = com.mallardsoft.tuple.Tuple.get1(p); 
			
			String s = "input[value='" + com.mallardsoft.tuple.Tuple.get2(p) + "']";
			
			/* Check the needed radio controls, walk the DOM tree to find the open/close links, fire their events
