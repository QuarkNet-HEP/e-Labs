...
<html xmlns="http://www.w3.org/1999/xhtml">
		<head>
				...
				<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAOVAjqr3Dmiiapsr-vKkj71kvRhxu90NQ"></script>
		...
		<body id="data-map">
				...
				<div id="container">
						...
						<input type="hidden" name="submitToPage" id="submitToPage" value="${fn:escapeXml(submitToPage)}"></input>
						<input type="hidden" name="study" id="study" value="${fn:escapeXml(study)}"></input>
