...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Lifetime-Advanced Study Analysis Results</title>
...
<p>
	<e:rerun type="lifetime-advanced" id="${results.id}" label="Change"/> your parameters
</p>
<% if (!user.isGuest()) { %>
<p><b>OR</b></p>
...
<p>
	<form name="SaveForm" action="../analysis/save.jsp"  method="post" target="saveWindow" onsubmit='return validatePlotName("newPlotName");' align="center">
		...
		<input type="hidden" name="metadata" value="transformation string I2U2.Cosmic::LifetimeStudyAdvanced"/>
		<input type="hidden" name="metadata" value="study string lifetime-advanced"/>
