...
//Permission granted only to development team
...
<TR><TD class="library_header"><%=Up_searchFunction%> <%=referenceText%>s.
</TD></TR>
</TABLE>
...
// To make it work for any e-Lab, we need to search on project as well.  LQ - July 27, 2006
    //  q="type=\'"+searchType+"\'";
      q = "type=\'" + searchType + "\'  and ( project=\'" + eLab + "\' or project=\'all\')";
