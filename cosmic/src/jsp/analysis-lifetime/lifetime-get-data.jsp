...
<%
	...
	String fileName = results.getOutputDir()+"/frequencyOut";
...
//	else {
		...
		LifetimePlotData ppd = new LifetimePlotData(file);
		
		GsonBuilder gb = new GsonBuilder();
		gb.registerTypeAdapter(LifetimePlotData.class, new LifetimeDataJsonSerializer());
		Gson gson = gb.create(); 
