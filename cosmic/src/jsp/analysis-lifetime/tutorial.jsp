			...
			<table width = "655" cellpadding ="8">
				...
				<tr>
					<td colspan=3>
						...
						vetoes are a useful concept but not available in the e-Lab analysis tools at the moment.  
				...
				<tr>
					<td colspan=3>
						&nbsp;
						<p align=center> Tutorial Pages: <b>1</b> <a href="tutorial2.jsp">2</a> <a href="tutorial3.jsp">3</a>  & <a href="index.jsp">Analysis</a></p>	
					</td>
				</tr>
			</table>
			<p>
