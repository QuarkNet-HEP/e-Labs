			...
			<table width = "655" cellpadding ="8">
				...
				<tr>
					<td colspan=3>
						...
						wait around a while and then <a href="javascript:glossary('decay',350)">decay</a>  into an electron, a neutrino and an anti-neutrino. The muon will leave one signature in the detector, and the electron will leave another. You can ask, "How long before the muon decays?" "What is its 
						<a href="javascript:glossary('lifetime',100)">lifetime</a>?"  Consider the figure below.
						<br>
