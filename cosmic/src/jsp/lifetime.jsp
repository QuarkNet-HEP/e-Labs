...
%>
    ...
    <%-- Set every string that is *valid* as an empty string as an empty string (initially) --%>
...
<!-- form for analysis options. Put before analyzing_list since it includes form inputs -->
