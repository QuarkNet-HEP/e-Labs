<%-- TODO: Each e-Lab uses an individual version of this file, despite the fact that there's a common file for it.  That seems like a small improvement to be made. - JG 5Feb2018 --%>

<%-- Users selecting any 'guest' login link are redirected to this page.
It may also be in other workflow paths, but that's the one I'm following now.
                                                          - JG 3Jun2020 --%>
