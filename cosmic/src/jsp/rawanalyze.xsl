    ...
    <td align="center">
     <a>
      <xsl:attribute name="href">
       view.jsp?filename=<xsl:value-of select="/file/filename"/>&#38;type&#61;data&#38;menu&#61;yes&#38;get&#61;data&#38;highlight&#61;yes&#38;line&#61;<xsl:value-of select="orphan/rising/line"/>
      </xsl:attribute>
  ...
  <tr>
   ...
   <xsl:for-each select="/file/channel">
    <td align="center">
     <a>
      <xsl:attribute name="href">
       view.jsp?filename=<xsl:value-of select="/file/filename"/>&#38;type&#61;data&#38;menu&#61;yes&#38;get&#61;data&#38;highlight&#61;yes&#38;line&#61;<xsl:value-of select="orphan/falling/line"/>
      </xsl:attribute>
  ...
  <tr>
   ...
   <xsl:for-each select="/file/channel">
    <td align="center">
     <a>
      <xsl:attribute name="href">
       view.jsp?filename=<xsl:value-of select="/file/filename"/>&#38;type&#61;data&#38;menu&#61;yes&#38;get&#61;data&#38;highlight&#61;yes&#38;line&#61;<xsl:value-of select="FBR/line"/>
      </xsl:attribute>
  ...
  <xsl:for-each select="/file/coincidence/fold">
   <tr>
    ...
    <td>
     <a>
      <xsl:attribute name="href">
       view.jsp?filename=<xsl:value-of select="/file/filename"/>&#38;type&#61;data&#38;menu&#61;yes&#38;get&#61;data&#38;highlight&#61;yes&#38;line&#61;<xsl:value-of select="line"/>
      </xsl:attribute>
      <xsl:value-of select="count"/>
     </a>
    </td>
 ...
 <table border="1">
  ...
  <tr>
   ...
   <td colspan="2" align="center">
     <a>
      <xsl:attribute name="href">
       view.jsp?filename=<xsl:value-of select="/file/filename"/>&#38;type&#61;data&#38;menu&#61;yes&#38;get&#61;data&#38;highlight&#61;yes&#38;line&#61;<xsl:value-of select="file/gps/noupdate/line"/>
      </xsl:attribute>
