...
5 - To test if the install is successful (either a MAC or PC): 
    ...
    *******************************************
    ...
    If you get any other output, please copy/paste it in an email to e-labs@fnal.gov.
...
8 - If you are using any other OS and are not able to get EQUIP to run, please send an email to e-labs@fnal.gov. Other users that have successfully
